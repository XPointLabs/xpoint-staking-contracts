...
contract ServiceNodeContributionEchidnaTest {
    ...
    constructor() {
        ...
        seshToken = new MockERC20("XPoint", "XPNT", 9);
        ...
        blsPubkey.data = hex"";
        ...
        ServiceNodeContribution implementation = new ServiceNodeContribution();
        snContribution = ServiceNodeContribution(Clones.clone(address(implementation)));
        snContribution.initialize(
    ...
    function echidna_prop_check_immutable_props() public view returns (bool) {
        ...
        bytes memory contractBlsPubkey = snContribution.blsPubkey();
        ...
        bool result = address(snRewards) == address(snContribution.stakingRewardsContract()) &&
            ...
            keccak256(blsPubkey.data) == keccak256(contractBlsPubkey) &&
            snParamsLockedIn;
        assert(result);
        return result;
    }
