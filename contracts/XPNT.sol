...
/**
 * @title XPoint token contract
 * @notice Deep ecosystem token with Arbitrum Custom Gateway support.
 */
contract XPNT is ICustomToken, ERC20, ERC20Permit, Shared {
    ...
    constructor(
        ...
        address _gateway,
        address _router
     ) ERC20("XPoint", "XPNT") ERC20Permit("XPoint") nzAddr(receiverGenesisAddress) nzUint(totalSupply_) {
